...
```{r}
# occurrence data frame spans from column 1-39, all columns beyond that belongs to measurement or fact extension
occ_df <- data[, 1:39]
head(occ_df)
```
...
BOLD processID is concatenated with REST API Full Data Retrieval (Specimen + Sequence) url and placed under `associatedOccurrences` field.
